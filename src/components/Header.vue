<template>
      ...
      <div class="row">
        ...
        >
          <ul class="nav">
            <li class="nav-item">
              <a
                class="nav-link bi bi-instagram"
                href="https://www.instagram.com/svwinds/"
              ></a>
            </li>
            <li class="nav-item">
              <a
                class="nav-link bi bi-facebook"
                href="https://www.facebook.com/SVWINDS"
              ></a>
            </li>
            <li class="nav-item">
              <a
                class="nav-link bi bi-youtube"
                href="https://www.youtube.com/channel/UC_XA3xjKpm9a61XSlKZe8xw"
              ></a>
            </li>
          </ul>
        </div>
        ...
        <div class="row mt-4">
          <div class="col-lg-6 col-md-12 offset-lg-3">
            <ul class="nav d-flex justify-content-around">
              <li class="nav-item">
                <router-link
                  class="nav-link link-underscore active"
                  :to="'/' + appPath.home"
                  >首頁</router-link
                >
              </li>
                  ...
                  <div class="my-dropdown-content">
                    <router-link
                      class="
                        ...
                        fs-6
                        my-dropdown-content-link
                        d-block
                        py-2
                        ps-2
                      "
                      :to="'/' + appPath.introduceband"
                      >樂團簡介</router-link
                    >
                    <router-link
                      class="
              ...
              <li class="nav-item">
                <router-link
                  class="nav-link link-underscore"
                  :to="'/' + appPath.performanceinfo"
                  >演出資訊</router-link
                >
              </li>
              <li class="nav-item">
  ...
  <div class="row d-flex d-md-none">
    <div class="col-2 col-sm-3">
      <button
        class="border border-0 bg-transparent ms-4"
        type="button"
        data-bs-toggle="offcanvas"
        data-bs-target="#slidecanvas"
        aria-controls="slidecanvas"
      >
    ...
    <div
      class="offcanvas offcanvas-start px-0 w-50"
      tabindex="-1"
      id="slidecanvas"
      aria-labelledby="slidecanvaslabel"
    >
        ...
        <div class="row mx-1 d-flex align-items-start flex-column h-100">
          <div class="col-12">
            <div class="row border-bottom py-3">
              <router-link
                class="text-decoration-none text-reset fs-5"
                :to="'/' + appPath.home"
                >首頁</router-link
              >
            </div>
          ...
          <div class="col-12">
            <div class="row border-bottom py-3" @click="isOpen = !isOpen">
              ...
              <div
                class="col-3"
                :class="[isOpen ? 'rotate-open' : 'rotate-close']"
              >
          ...
          <div
            class="col-12 collaspe"
            :class="[isOpen ? 'collaspe-open' : 'collaspe-close']"
          >
            <button
              class="
                w-100
            ...
            >
              <router-link
                class="text-decoration-none text-reset fs-6 my-1"
                :to="'/' + appPath.introduceband"
                >樂團簡介</router-link
              >
            </button>
          ...
          <div class="border-bottom py-3">
            <a
              class="fs-5 text-reset text-decoration-none"
              href="https://www.instagram.com/svwinds/"
              >Instagram</a
            >
          </div>
